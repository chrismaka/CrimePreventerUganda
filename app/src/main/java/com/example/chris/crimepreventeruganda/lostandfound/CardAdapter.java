...
import com.example.chris.crimepreventeruganda.wanted.CustomVolleyRequest;
 ...
 */
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.thugs_list, parent, false);
