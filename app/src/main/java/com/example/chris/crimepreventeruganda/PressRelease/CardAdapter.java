...
import com.example.chris.crimepreventeruganda.PressRelease.CustomVolleyRequest;

import java.util.List;

/**
 * Created by chris on 9/22/2017.
 */
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.press_list, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.textViewName.setText(superthug.getTitlez());
        holder.textViewDescription.setText(superthug.getDatez());
