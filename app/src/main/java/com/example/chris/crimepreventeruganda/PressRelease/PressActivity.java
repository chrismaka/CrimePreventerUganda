package com.example.chris.crimepreventeruganda.PressRelease;
...
import com.example.chris.crimepreventeruganda.PressRelease.Config;
import com.example.chris.crimepreventeruganda.PressRelease.Thugs;
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Config.DATA_URL + String.valueOf(requestCount),
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PressActivity.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void parseData(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                wantedz.setTitlez(json.getString(Config.TAG_TITLE));
                wantedz.setDatez(json.getString(Config.TAG_DATE));
